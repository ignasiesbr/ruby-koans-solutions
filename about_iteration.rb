...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It is a fold operation. Given an accumulator (first argument in the block) and an initial value, iterates.
  end
  ...
  #   # code to read 'file'
  #
  # I guess beacuse with the do block, after it's executed the file closes 
